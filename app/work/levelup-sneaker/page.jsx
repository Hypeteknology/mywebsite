...
const frameImages = [
  {
    ...
    desc: "A design system that reflects energy, streetwear culture, and brand authenticity.",
    link: "https://www.levelupsneakers.com/",
  },
  {
    src: "/images/level2.jpg",
    title: "Content That Educates",
    desc: "Informative visuals and copy that explain product features, sizing, and sneaker care.",
    link: "https://www.levelupsneakers.com/",
  },
];
...
const socials = [
  {
    ...
    desc: "Eye-catching creatives and stories that drive engagement and direct sales.",
    href: "https://www.instagram.com/levelup.sneakers/",
    img: "/images/levelinsta.jpg",
  },
];

export default function Lsneaker() {
  return (
    <main className="min-h-screen bg-white text-gray-900 font-['goudy-old-style',Georgia,serif,sans-serif]">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-3">
        ...
        <header className="relative w-full h-[56vh] md:h-[90vh] overflow-hidden mb-12">
          ...
          <div className="absolute inset-0 z-10 flex items-end">
            <div className="max-w-3xl p-6 md:p-12">
              ...
              >
                How Levelup Sneaker built a streetwear brand presence that connects, educates, and converts.
              </motion.p>
            </div>
          </div>
        </header>
        ...
        <section className="mb-16">
          <h2 className="text-2xl md:text-3xl mb-4">Levelup Sneaker</h2>
          <p className="text-gray-800 leading-relaxed mb-6">
            Levelup Sneaker is a streetwear sneaker brand that aims to bring premium designs to young, fashion-conscious audiences. We created a bold visual identity and a content strategy that informs and excites customers.
          </p>
              ...
              <Link key={i} href={it.link} target="_blank">
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                    <span className="text-white text-lg font-medium">Visit Levelup Sneaker →</span>
                  </div>
              ...
              >
                <article>
                  <div className="relative h-72">
                    ...
                    />
                    <div className="absolute inset-0 bg-black/50 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <span className="text-white text-base font-medium">Visit Levelup Sneaker →</span>
                    </div>
                  </div>
        ...
        {/* ===== SECTION 2 ===== */}
        <section className="mb-16">
          <h2 className="text-2xl md:text-3xl mb-4">Social & Digital Strategy</h2>
          <p className="text-gray-700 mb-8 max-w-2xl">
            We developed campaigns to increase brand awareness, drive engagement, and convert sneaker enthusiasts into loyal customers using Instagram as the primary channel.
          </p>
        ...
        <section className="mb-16">
          ...
          <p className="text-gray-700 mb-6 max-w-3xl">
            We implemented analytics and operational dashboards to monitor campaigns, optimize performance, and convert every interested visitor into a qualified customer.
          </p>

          {/* Desktop - 2 images */}
          <div className="hidden md:flex gap-6 px-10">
            {["/images/level3.jpg", "/images/level3.jpg"].map((src, i) => (
          ...
          <p className="text-gray-700 mt-5 max-w-5xl">
            Data-driven optimization ensured high engagement, increased sales, and strong customer retention.
          </p>
        </section>
        ...
        <section className="mb-16">
          <div className="relative w-full md:h-[90vh] h-[26vh] mb-6 overflow-hidden">
            <Image src="/images/levelf.jpg" alt="Launch visual" fill className="object-cover" />
          </div>
          <p className="text-gray-800 leading-relaxed max-w-4xl">
            The phased launch strategy built hype, educated customers, and successfully converted sneaker enthusiasts into buyers.
          </p>
        </section>
